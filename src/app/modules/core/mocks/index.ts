...
import {
  Account, BackupAccountsResponse, BeaconStatusResponse, ExportSlashingProtectionResponse, GenerateMnemonicResponse, ImportKeystoresResponse, InitializeAuthResponse, ListAccountsResponse, WalletResponse
...
export const Mocks: IMocks = {
  ...
  '/v2/validator/wallet/keystores/import': {
    imported_public_keys: mockImportedKeys,
