...
export const Http = {
  ...
  toJSON(message: Http): unknown {
    ...
    obj.fullyDecodeReservedExpansion = message.fullyDecodeReservedExpansion || false;
    return obj;
  },
};
...
export const HttpRule = {
  encode(message: HttpRule, writer: Writer = Writer.create()): Writer {
    ...
    if (message.custom !== undefined && message.custom !== undefined) {
  ...
  toJSON(message: HttpRule): unknown {
    ...
    obj.get = message.get || undefined;
    obj.put = message.put || undefined;
    obj.post = message.post || undefined;
    obj.delete = message.delete || undefined;
    obj.patch = message.patch || undefined;
